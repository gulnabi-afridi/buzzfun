    ...
    <div className="w-full p-3 flex flex-col">
      ...
      <div className="w-full bg-transparent dark:bg-[#1B2A35] px-4 h-[50px] flex justify-between items-center">
        <div className="flex px-2 py-[4px] bg-white-1 dark:bg-black-1 justify-center items-center gap-2">
          <p className="text-[14px] font-bold text-white-1 dark:text-white-1">News</p>
      ...
      <div className="w-full bg-[#D4DDE6] h-[40px] px-4 flex justify-between items-center ">
        ...
        <button className="px-3 py-1 bg-[#1957EA] text-[14px] font-normal text-white-1/80 rounded-[5px]">
          New Post
        </button>
      </div>
      {/* update bar ---> */}
      ...
      <div className="w-full grid mt-2 gap-2 grid-cols-[3fr,1fr]">
        ...
        <div className="w-full flex gap-2 flex-col">
          <p className="text-[14px] font-normal text-[#004BFE]">Subheading</p>
        ...
        <div className="w-full flex justify-center items-center gap-2 flex-col">
          ...
          <div className="w-full justify-center items-center flex flex-col gap-2">
            {links.map((link, index) => {
              return (
                <p key={index} className="text-white-1 font-normal text-[14px]">
                  {link}
                </p>
              );
            })}
