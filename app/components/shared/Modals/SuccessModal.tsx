...
const SuccessModal: React.FC<Props> = ({ open, size, onClose }: Props) => {
  return (
    <Modal
      opened={open}
      onClose={onClose}
      ...
      <div className="w-full justify-center items-center flex flex-col">
        ...
        <div className="w-full flex justify-between items-center">
          <div className="flex justify-center items-center gap-1">
            <BsCheckCircle className="text-[#FEF652] text-[20px]" />
            <p className="text-[14px] font-normal text-white-1">
              {" "}
              <span className="bg-yellow-1 px-[4px] py-[2px] text-black-1">
              Success
              </span>{" "}
            </p>
          </div>
        ...
        <div className="w-[210px] h-[133px] relative">
          <Image src="/assets/sucess.png" fill alt="" />
        </div>
        ...
        <p className="text-[10px] underline font-normal text-[#747474]">
        View Transaction
        </p>
        <div className="w-full h-[1px] my-4 bg-white-1/10"></div>
