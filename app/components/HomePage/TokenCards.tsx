...
const TokenCards: React.FC = () => {
  return (
    <div className="w-full grid grid-cols-1 cmd:grid-cols-2 xl:grid-cols-3 gap-3">
      {/* 1st col ----> */}
      <div className="w-full h-full flex justify-center items-center">
        <div className="w-full h-full border-[1px] border-[#535353] max-w-[500px] dark:bg-black-1 bg-white-1 rounded-[5px] py-4 px-3 flex flex-col gap-4">
          {/* top header ---> */}
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-start pl-2 items-center gap-1">
                  ...
                  <p className="text-[12px] font-normal text-white-1">TICKER</p>
                  <Image
                ...
                <p className="text-[12px] w-full flex justify-start items-center font-normal text-white-1">
                  5600 msgs
                </p>
                {/* users  */}
                <p className="text-[12px] w-full flex justify-end items-center font-normal text-white-1">
                  5600 users
                </p>
              </div>
            );
      ...
      <div className="w-full h-full flex justify-center items-center">
        {/* table ---> */}
        <div className="w-full h-full flex flex-col gap-4 bg-black-1 border-[1px] border-[#FEF652] rounded-[5px] py-4 px-3">
          {/* table filter -->  */}
          <div className="flex justify-center items-center gap-2">
            <div className="flex w-full justify-between items-center">
              ...
              <button className="w-[24px] flex justify-center items-center h-[24px] rounded-[3px] bg-[#EBFF00C4]">
            ...
            {[0, 1, 2, 3, 4].map((item, index) => {
              return (
                ...
                >
                  ...
                  {/* MC  */}
                  <div className="w-full border-r-[1px] border-[#B746F0]  flex gap-1 justify-center items-center ">
                    <p className="text-[10px] font-normal text-white-1">MC</p>
                    <p className="text-[10px] font-normal text-[#00C673]">
                      $400k
                    </p>
                  </div>
                  {/* volume  */}
                  <div className="w-full border-r-[1px] border-[#B746F0]  flex gap-1 justify-center items-center ">
                    <p className="text-[10px] font-normal text-white-1">V</p>
                    <p className="text-[10px] font-normal text-[#00C673]">
                      $900k
                    </p>
                  </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-start items-center gap-2">
                  <div className="w-[20px] h-[20px] rounded-full bg-[#EF7216]"></div>
                  <p className="text-[12px] font-normal text-white-1">Username</p>
