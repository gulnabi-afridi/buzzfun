    ...
    <div className="w-full mt-6 flex justify-center items-center">
      <div className="w-full hideScroll overflow-auto max-w-[1000px] justify-center items-center">
        <div className="min-w-[930px] w-full flex gap-4">
          ...
          <div className="h-[86px] border-[1px] border-black-1 dark:border-white-1/50 tableShadow dark:forDarkShadow gap-3 rounded-[5px] bg-black-1 px-5 flex justify-center items-center">
