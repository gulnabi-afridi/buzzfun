...
const Stats = () => {
  return (
    <div className="w-full mt-4 flex justify-center items-center">
      <div className="w-full max-w-[1000px] flex justify-center items-center gap-4">
        <Image src="/assets/triangle.svg" width={47} height={79} alt="" />
        <div className="h-[86px] gap-3 rounded-[5px] bg-black-1 px-5 flex justify-center items-center">
