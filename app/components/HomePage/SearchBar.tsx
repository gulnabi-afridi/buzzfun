      ...
      <div className="flex justify-center items-center gap-4">
        <Select
          ...
          classNames={{
            ...
            dropdown:'dark:!bg-black-1 bg-transparent !border-none !text-black-1 dark:!text-white-1',
            input:
        ...
        <p className="text-[12px] font-normal dark:text-white-1 text-black-1">{pattern1}</p>
      </div>
    </div>
  );
};
