...
const Replies: React.FC = () => {
  return (
    <div className="w-full md:mt-0 mt-0 sm:mt-5 md:col-span-1 col-span-1 sm:col-span-2 flex justify-center items-center">
      <div className="w-full bg-transparent dark:bg-black-1 max-w-[500px] overflow-auto flex gap-3 flex-col rounded-[2px] border-[1px] border-blue-1 px-3 py-3">
        <p className="text-[14px] font-normal dark:text-white-1 text-black-1 ">Replies</p>
