  ...
  return (
    <div className="w-full md:col-span-1 md:mt-8 mt-0 sm:mt-5 col-span-1 sm:col-span-2 flex justify-center items-center">
      <div className="w-full max-w-[290px] flex flex-col gap-3">
        <p className="text-[14px] w-fit font-normal rounded-[2px] dark:bg-yellow-1 px-2 py-1 bg-transparent text-black-1 ">Following</p>
        <div className="w-full flex h-[600px] dark:bg-black-1 bg-transparent scrollSize overflow-auto bg-white-1 flex-col border-[1px] dark:border-[#317C85] border-blue-1 rounded-[2px] gap-3 px-2 py-1">
          {/* rows ---> */}
          {[
