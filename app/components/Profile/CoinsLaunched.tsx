      ...
      <div className="w-full flex flex-col gap-2">
        {[0, 1, 2, 3].map((item, index) => {
          return (
            <div
              key={index}
              className="w-full border-[1px] bg-white-1 gap-3 border-blue-1 p-3 rounded-[2px] grid grid-cols-[140px,1fr]"
            >
              ...
              <div className="w-full flex flex-col">
                ...
                <div className="flex py-1 mt-1 justify-start items-center gap-3">
                  <p className="text-[10px] font-montserrat font-semibold">
                    Market cap:
                  </p>
                  <p className="text-[10px] font-normal font-montserrat uppercase text-black-1">
                    45.3K
                  </p>
                  <p className="text-[10px] font-normal font-montserrat uppercase text-black-1">
                ...
                <div className="flex py-1 justify-start items-center gap-3">
                  ...
                  <p className="text-[10px] font-semibold font-montserrat uppercase text-black-1">
                    45
                  </p>
                </div>
                {/* Token name: */}
